...
@Component({
    ...
    <div class="el-dash">
      <div class="el-dash-header">
        <div>
          ...
          <p class="el-dash-subtitle">Resumen de tu actividad y rendimiento</p>
        </div>
        <div class="el-dash-actions">
          <button pButton label="Nuevo Servicio" icon="pi pi-plus" class="el-btn-primary" (click)="navigate('/technician/catalog')"></button>
        </div>
      </div>
      ...
      <div class="el-dash-grid">
        <p-card class="el-table-card">
          <ng-template pTemplate="header">
            <div class="el-card-header">
              ...
              <button pButton icon="pi pi-calendar" label="Ver Todo" class="p-button-text p-button-sm"></button>
            </div>
          </ng-template>
          <table class="el-table">
            ...
            <tbody>
              <tr *ngFor="let job of upcomingJobs">
                <td class="el-cell-name">{{ job.client }}</td>
                <td>{{ job.service }}</td>
                <td>{{ job.date }}</td>
                <td><p-tag [value]="job.status" [severity]="getSeverity(job.status)"></p-tag></td>
              </tr>
            </tbody>
          </table>
        </p-card>
        ...
        <div class="el-quick-actions">
          ...
          <button class="el-qa-btn" (click)="navigate('/technician/inventory')">
            <i class="pi pi-box"></i>
            <span>Gestionar Inventario</span>
            <i class="pi pi-chevron-right el-qa-arrow"></i>
          </button>
          <button class="el-qa-btn" (click)="navigate('/technician/profile')">
            <i class="pi pi-user"></i>
            <span>Mi Perfil</span>
            <i class="pi pi-chevron-right el-qa-arrow"></i>
          </button>
          <button class="el-qa-btn" (click)="navigate('/technician/analytics')">
  ...
  styles: [`
    ...
    .el-kpi-icon--home { background: #eff6ff; color: #3b82f6; }
    .el-kpi-icon--box { background: #fef3c7; color: #f59e0b; }
    .el-kpi-icon--star { background: #fef2f2; color: #ef4444; }
    .el-kpi-icon--dollar { background: #f0fdf4; color: #22c55e; }
...
export class TechnicianDashboardComponent {
  ...
  kpis: KpiCard[] = [
    { label: 'Servicios Totales', value: '48', change: '+12% este mes', positive: true, icon: 'pi pi-home' },
    { label: 'Trabajos Activos', value: '6', change: '2 urgentes', positive: false, icon: 'pi pi-box' },
    { label: 'Calificación', value: '4.8', change: 'Excelente', positive: true, icon: 'pi pi-star' },
    { label: 'Ganancias del Mes', value: '$3,450', change: '+8% vs mes anterior', positive: true, icon: 'pi pi-dollar' },
    { label: 'Próxima Cita', value: 'Hoy 4pm', change: 'Martínez - Reparación', positive: true, icon: 'pi pi-clock' },
  ];
